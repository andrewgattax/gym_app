...
class ExerciseTile extends StatefulWidget {
  ...
  ExerciseTile(
      {required this.onDelete, required this.ex, required this.onEdit});
...
class _ExerciseTileState extends State<ExerciseTile> {
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return EditExerciseDialog(
              onEdit: modificaEsercizio, exercise: widget.ex);
        });
  }
  ...
  ImageIcon getIcon() {
    switch (widget.ex.exType) {
      case 1:
        return ImageIcon(AssetImage("assets/icons/chest.png"),
            size: 40, color: Colors.black);
      case 2:
        return ImageIcon(AssetImage("assets/icons/back.png"),
            size: 40, color: Colors.black);
      case 3:
        return ImageIcon(AssetImage("assets/icons/leg.png"),
            size: 40, color: Colors.black);
      default:
        return ImageIcon(AssetImage("assets/icons/chest.png"),
            size: 40, color: Colors.black);
                          ...
                          child: Align(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  widget.ex.sets.toString() +
                                      " sets, " +
                                      widget.ex.reps.toString() +
                                      " reps, " +
                                      normalizeWeight(widget.ex.weight) +
                                      " Kg",
